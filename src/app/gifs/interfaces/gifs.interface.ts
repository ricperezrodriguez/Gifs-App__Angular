// To parse this data:
//
//   import { Convert, SearchGifsResopnse } from "./file";
//
//   const searchGifsResopnse = Convert.toSearchGifsResopnse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGifsResopnse {
    data:       Gif[];
...
export class Convert {
    public static toSearchGifsResopnse(json: string): SearchGifsResopnse {
        return cast(JSON.parse(json), r("SearchGifsResopnse"));
    }

    public static searchGifsResopnseToJson(value: SearchGifsResopnse): string {
        return JSON.stringify(uncast(value, r("SearchGifsResopnse")), null, 2);
    }
}
